...
<script type="text/javascript">
function uploadFile() {
	//cria um element para manipulação do campo de imagem
	var target = document.querySelector('img');
	//cria um element para manipulação do campo de upload de arquivos
	var file = document.querySelector('input[type=file]').files[0];

	var reader = new FileReader();
	
	//se tiver alguma imagem no element file, ele realiza a leitura
	if (file) {

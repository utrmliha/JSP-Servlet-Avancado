	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			if (acao.equalsIgnoreCase("carregar")){
				...
				String imagem = daoUsuario.consultarBase64(iduser);
				if (imagem != null){
					
					response.setHeader("Content-Disposition", "attachment;filename=arquivo." + daoUsuario.consultarContent(iduser));
					
					//Converte base 64 em bytes
					byte [] imageBytes = Base64.decodeBase64(imagem);
